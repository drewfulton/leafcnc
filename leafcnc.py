...
class Initilization(tkinter.Frame):
	def __init__(self, parent, controller):
		...
		btnCNCLeftLarge.grid(row=21, column=11)
		btnCNCLeftMed.grid(row=22, column=11)
		btnCNCLeftSmall.grid(row=23, column=11)
		btnCNCDownLarge.grid(row=30, column=13)
		btnCNCDownMed.grid(row=31, column=13)
