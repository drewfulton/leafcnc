...
class Initilization(tkinter.Frame):
	def __init__(self, parent, controller):
		...
		btnCNCLeftLarge.grid(row=13, column=10)
		btnCNCLeftMed.grid(row=13, column=11)
		btnCNCLeftSmall.grid(row=13, column=12)
		btnCNCDownLarge.grid(row=16, column=13)
		btnCNCDownMed.grid(row=15, column=13)
		btnCNCDownSmall.grid(row=14, column=13)
		btnCNCRightLarge.grid(row=13, column=16)
		btnCNCRightMed.grid(row=13, column=15)
		btnCNCRightSmall.grid(row=13, column=14)
