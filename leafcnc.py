...
class CameraCalibration(tkinter.Frame):
	...
	def __init__(self, parent, controller):
		...
		lblBottomWidth.grid(row=24, column=13, sticky="WE")
		entryBottomWidth.grid(row=24, column=14, sticky="WE")
		...
		lblTop.grid(row=30, column=10, sticky="WE")
		lblTopHeight.grid(row=32, column=10, sticky="WE")
		entryTopHeight.grid(row=32, column=11, sticky="WE")
		lblTopWidth.grid(row=34, column=13, sticky="WE")
		entryTopWidth.grid(row=34, column=14, sticky="WE")
