		...
		def sessionWindow(events, sessionStatus):
			...
			while not events["complete"].is_set():
				...
				if events["sampleInfoInit"].is_set():
					...
					lblSampleSizeX = ttk.Label(sampleInfoInitWindow, text="Sample Height (mm):", font=MED_FONT)
					...
					lblSampleSizeY = ttk.Label(sampleInfoInitWindow, text="Sample Width (mm):", font=MED_FONT)
