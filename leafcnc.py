...
# 					playSound("error")
					...
					sampleInfoInitWindow.grid_columnconfigure(3, minsize=70)
					...
					lblSampleID.grid(row=2, column=2, sticky="NEWS")
					entrySampleID.grid(row=2, column=3, sticky="NEWS")
					...
					lblCameraHeight.grid(row=4, column=2, sticky="NEWS")
					entryCameraHeight.grid(row=4, column=3, sticky="NEWS")
					...
					lblStackingMode.grid(row=6, column=2, sticky="NEWS")
					cmbStackingMode.grid(row=6, column=3, sticky="NEWS")
					...
					lblStackingCount.grid(row=8, column=2, sticky="NEWS")
					entryStackingCount.grid(row=8, column=3, sticky="NEWS")
					...
					lblSampleSizeX.grid(row=10, column=2, sticky="NEWS")
					entrySampleSizeX.grid(row=10, column=3, sticky="NEWS")
					...
					lblSampleSizeY.grid(row=12, column=2, sticky="NEWS")
					entrySampleSizeY.grid(row=12, column=3, sticky="NEWS")
