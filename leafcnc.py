...
class Initilization(tkinter.Frame):
	def __init__(self, parent, controller):
		...
		btnCNCDownLarge = ttk.Button(self, text="Down 100mm", command=lambda: moveCNCbyAmount(0, -100, machine), width=25, height=25)
		...
		btnCNCRightLarge = ttk.Button(self, text="Right 100mm", command=lambda: moveCNCbyAmount(100, 0, machine), width=25, height=25)
