...
class Initilization(tkinter.Frame):
	def __init__(self, parent, controller):
		...
		self.grid_rowconfigure(11, minsize=45)
		...
		self.grid_rowconfigure(31, minsize=45)
		...
		btnCNCUpSmall = ttk.Button(self, text="Up 5mm", command=lambda: moveCNCbyAmount(0, 5, machine), width=8)
		btnCNCUpMed = ttk.Button(self, text="Up 50mm", command=lambda: moveCNCbyAmount(0, 50, machine), width=15)
		btnCNCUpLarge = ttk.Button(self, text="Up 100mm", command=lambda: moveCNCbyAmount(0, 100, machine), width=25)
		btnCNCLeftSmall = ttk.Button(self, text="Left 5mm", command=lambda: moveCNCbyAmount(-5, 0, machine), width=8)
		btnCNCLeftMed = ttk.Button(self, text="Left 50mm", command=lambda: moveCNCbyAmount(-50, 0, machine), width=15)
		btnCNCLeftLarge = ttk.Button(self, text="Left 100mm", command=lambda: moveCNCbyAmount(-100, 0, machine), width=25)
		btnCNCDownSmall = ttk.Button(self, text="Down 5mm", command=lambda: moveCNCbyAmount(0, -5, machine), width=8)
		btnCNCDownMed = ttk.Button(self, text="Down 50mm", command=lambda: moveCNCbyAmount(0, -50, machine), width=15)
		btnCNCDownLarge = ttk.Button(self, text="Down 100mm", command=lambda: moveCNCbyAmount(0, -100, machine), width=25)
		btnCNCRightSmall = ttk.Button(self, text="Right 5mm", command=lambda: moveCNCbyAmount(5, 0, machine), width=8)
		btnCNCRightMed = ttk.Button(self, text="Right 50mm", command=lambda: moveCNCbyAmount(50, 0, machine), width=15)
		btnCNCRightLarge = ttk.Button(self, text="Right 100mm", command=lambda: moveCNCbyAmount(100, 0, machine), width=25)
	
		self.btnLiveView = ttk.Label(self, text="")
		self.btnLiveView.grid(row=20, column=13, sticky="NEWS", rowspan=4)
		...
		btnCNCLeftLarge.grid(row=21, column=11, sticky="NEWS")
		btnCNCLeftMed.grid(row=22, column=11, sticky="NEWS")
		btnCNCLeftSmall.grid(row=23, column=11, sticky="NEWS")
		btnCNCDownLarge.grid(row=30, column=13, sticky="NEWS")
		btnCNCDownMed.grid(row=31, column=13, sticky="NEWS")
		btnCNCDownSmall.grid(row=32, column=13)
		btnCNCRightLarge.grid(row=21, column=14)
		btnCNCRightMed.grid(row=22, column=14)
		btnCNCRightSmall.grid(row=23, column=14)
